...
intro_text <- "I've spent the last several years at the Oklahoma Policy Institute developing tools to harness the power of data to build a more transparent and accountable justice system in our state. My work has focused on turning messy administrative data into compelling interactive data visualizations that deepen our understanding of how justice is done.
