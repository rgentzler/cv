...
- <i class="fa fa-envelope"></i> ryan.gentzler@gmail.com
- <i class="fa fa-twitter"></i> @rcgentzler
- <i class="fa fa-github"></i> github.com/rcgentzler
- <i class="fa fa-link"></i> [www.ryan.bingo](http://www.ryan.bingo)
...
Source code: [github.com/rgentzler/ryans-resume](https://github.com/rgentzler/ryans-resume).
